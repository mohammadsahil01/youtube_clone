...
export const SearchBar = () => {
    return (
      <div>
        <form>
          <div>
            <div className="relative max-sm:hidden block">
              <input
                type="search"
                id="search-dropdown"
            ...
            <button
                type="submit"
                className="absolute top-0 right-0 py-5 px-3 h-full hover:bg-gray-800 rounded-full flex items-center justify-center"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
